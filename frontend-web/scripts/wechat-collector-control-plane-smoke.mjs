...
for(const marker of ["WeChat Collector","wechat_mp_article","discover_articles","sync_articles","sync_media","capability_health","requires_action","登录","公众号搜索","运行历史","data-source-run-retry","data-source-run-cancel","sourceKnowledgeURL","wcplus-legacy-diagnostics","source-agent-enrollment-link","sourceControlPrefillFromLocation","isSourceControlPath","/wechat-import"]){assert.ok(js.includes(marker),`missing collector marker ${marker}`)}
...
assert.ok(!js.includes('href="/wcplus-source">WC Plus</a>'),"WC Plus should not remain a primary navigation item");
