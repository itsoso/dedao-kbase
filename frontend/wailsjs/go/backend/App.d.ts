...
export function BookKnowledgeChat(arg1:string,arg2:string,arg3:string,arg4:string):Promise<app.BookKnowledgeChatResponse>;

export function BookKnowledgeChatHistory(arg1:string,arg2:number):Promise<Array<app.BookKnowledgeChatHistoryItem>>;

export function BookKnowledgeExport(arg1:string,arg2:string):Promise<app.BookKnowledgeExportResult>;

export function BookKnowledgeGetBook(arg1:string):Promise<app.BookKnowledgePackage>;

export function BookKnowledgeListBooks():Promise<Array<app.BookKnowledgeBook>>;

export function BookKnowledgeMCPCall(arg1:string,arg2:{[key: string]: any}):Promise<string>;

export function BookKnowledgeMCPTools():Promise<Array<app.BookKnowledgeMCPTool>>;

export function BookKnowledgeNotebookLMBridge(arg1:string):Promise<app.BookKnowledgeNotebookLMBridge>;

export function BookKnowledgeNotebookLMExport(arg1:string):Promise<app.BookKnowledgeNotebookLMBridge>;
...
export function EbookDownloadAndSyncWiki(arg1:number,arg2:string):Promise<void>;
